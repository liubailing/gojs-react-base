...
export default {
	...
	childs: [
		...
		{
			key: 'cond',
			data: { tip: '这是一个cond   cond   cond   cond   cond   值' },
			...
			childs: [
				{
					...
					data: { tip: '这是一个branch   branch   branch   branch   branch   值' },
					childs: [
		...
		},
		{
			...
			parentKey: 'root',
			childs: [
				{ key: 'test-test', label: '测试', type: ActionNodeType.ExtractData as string },
				{
